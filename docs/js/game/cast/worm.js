...
(function () {
  ...
  M.worm = function (parent, o) {
    ...
    // o.s scales the worm himself (not the heap) about the ground point; the sway and the rise live on the inner group, so they scale with him untouched
    const worm = K.g(K.g(g, { s: o.s || 1 }));
    ...
    /** how far he is out of the ground, 0..1: he sinks into the heap (the ground hides the rest), he is never squashed */
    g.rise = (k) => K.tr(worm, { y: (1 - k) * 40 });
    return g;
  };
})();
