...
(function () {
  ...
  M.gnome = function (parent, x, y, z) {
    ...
    K.pad(-38, -170, 76, 140, g, { d: 40 });   // hat tip to hem; the boots and the plinth below are solid meshes and hit on their own, so the pad stops short of the ground (things lying beside his feet are not his)
